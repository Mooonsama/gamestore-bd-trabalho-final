...
6. **cartao_bancario** (entidade fraca)
...
1. **check_gerencia_overlap**: Impede sobreposição de períodos de gestão
2. **check_compra_data_lancamento**: Impede compra antes do lançamento
3. **check_avaliacao_compra**: Exige compra antes da avaliação
...
- **Zod**: Para validação de dados tanto no frontend quanto backend
- **Docker**: Para facilitar deployment e desenvolvimento
